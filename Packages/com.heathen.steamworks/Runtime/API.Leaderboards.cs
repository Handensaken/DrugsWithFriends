...
namespace Heathen.SteamworksIntegration.API
{
    ...
    public static class Leaderboards
    {
        ...
        public static class Client
        {
            ...
            /// <summary>
            /// Event triggered when a UGC (User-Generated Content) is attached to a leaderboard entry.
            /// </summary>
            /// <remarks>
            /// The event provides the result of the UGC attachment operation, including details of the UGC
            /// and a boolean indicating whether the operation was successful.
            /// </remarks>
            ...
            private static void ExecuteUgcRequest()
            {
                ...
                bgWorker.DoWork += (_, _) =>
                {
                    ...
                    while (_ugcQueue.Count > 0)
                    {
                        //Check on the next request
                        var request = _ugcQueue.Peek();
                        ...
                        if (request.Callback != null)
                        {
                            ...
                            _mLeaderboardUgcSetT.Set(handle, (r, e) =>
                            {
                            ...
                            //Wait until we get a result or until we time out
                            while (waiting)
                                Thread.Sleep(100);
                        }
            ...
            /// </summary>
            public static int PendingSetUgcRequests => _ugcQueue?.Count ?? 0;
            /// <summary>
            ...
            public static void AttachUgc(LeaderboardData leaderboard, UGCHandle_t ugc, Action<LeaderboardUgcSet, bool> callback)
            {
                ...
                _mLeaderboardUgcSetT ??= CallResult<LeaderboardUGCSet_t>.Create();

                _ugcQueue ??= new Queue<AttachUgcRequest>();
            ...
            /// <summary>
            /// Attaches a piece of user-generated content to a leaderboard entry.
            /// </summary>
            /// <remarks>
            /// The attached content can include metadata or additional data related to the leaderboard entry, such as a replay file or other game-specific data.
            /// The content is uploaded asynchronously and associated with the leaderboard entry.
            /// </remarks>
            /// <param name="leaderboard">The leaderboard to attach the user-generated content to. This is identified by a <see cref="LeaderboardData"/> handle.</param>
            /// <param name="fileName">The name of the file to create or update in the Steam Remote Storage.</param>
            /// <param name="jsonObject">The data object to serialize and store as part of the user-generated content. This is converted to a string using the given encoding.</param>
            /// <param name="encoding">The text encoding to use for converting the object into a storable format.</param>
            /// <param name="callback">A callback function that is invoked upon completion. The callback includes a <see cref="LeaderboardUgcSet"/> and a boolean indicating success or failure.</param>
            public static void AttachUgc(LeaderboardData leaderboard, string fileName, object jsonObject,
                System.Text.Encoding encoding, Action<LeaderboardUgcSet, bool> callback)
            {
                if (callback == null)
                    return;
            ...
            /// <summary>
            /// Attaches a piece of user-generated content to the specified leaderboard entry.
            /// </summary>
            /// <remarks>
            /// The user-generated content is written to Steam Remote Storage and linked to the leaderboard entry.
            /// This can be useful for attaching data such as replays, configurations, or other relevant assets.
            /// </remarks>
            /// <param name="leaderboard">The leaderboard to which the content will be attached.</param>
            /// <param name="fileName">The filename to use for storing the content in Steam Remote Storage.</param>
            /// <param name="content">The content to attach, provided as a string.</param>
            /// <param name="encoding">The text encoding to use when storing the content.</param>
            /// <param name="callback">A callback that will be invoked with the result of the operation.</param>
            public static void AttachUgc(LeaderboardData leaderboard, string fileName, string content,
                System.Text.Encoding encoding, Action<LeaderboardUgcSet, bool> callback)
            {
                if (callback == null)
                    return;
