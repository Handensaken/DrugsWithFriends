...
{
     public class NewHealthManager : NetworkBehaviour //TODO make total control over clients health
     {
          ...
          private static NewHealthManager _singleton;
          public static NewHealthManager Instance => _singleton;
